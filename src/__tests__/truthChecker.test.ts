// 2.5 Challenge 2: Create data sets to pass each test
...
describe("checking for truth", () => {
  test("are the littleNumbers < bigNumbers?", () => {
    ...
    let littleNumbers: Array<number> = [2.3, 5, 54, 74.7];
    let bigNumbers: Array<number> = [99, 133.5, 74.8, 101];
  ...
  test("there is a sequence to this test", () => {
    let values: Array<any> = ["diamond hands", true, 420]; // set values here - the array will take any type or combo of types.
